    ...
    m_pOwnerClass(pOwner)
{
    ...
    StaticText1 = new wxStaticText(Panel3, wxID_ANY, _("PROJECT_NUMBER"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
    ...
    StaticText8 = new wxStaticText(Panel3, wxID_ANY, _("OUTPUT_DIRECTORY"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
